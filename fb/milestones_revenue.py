...
Build an array with sums
go throw milestiones and search the smallest of the biggers

O(nlogn)

revenues    = [ 700,  800,  600,  400,  600, 700]
milestiones = [3100, 2200,  800, 2100, 1000] 

accum       = [ 700, 1500, 2100, 2500, 3100, 3800]
...
def getMilestoneDays(revenues, milestones):
    ...
    accum = [0] * len(revenues)
    accum[0] = revenues[0]
    for i in range(1, len(revenues)):
        accum[i] += accum[i - 1] + revenues[i]

    for n in milestones:
        output.append(bs(accum, n) + 1)
